...
function Footer() {
  return (
    <div className='bg-white'>
        <div className='max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 px-8'>
            {/* Nav footer */}
            <nav className='-mx-5 -my-2 flex flex-warp justify-center '>
                ...
                <div className='px-5 py-2'>
                    <Link to='/tags' className='text-base text-gray-500 hover:text-gray-900'>Tags
                    </Link>
                </div>
                <div className='px-5 py-2'>
